...
public class CanyonStructurePiece extends AbstractCaveGenerationStructure {
    protected CanyonStructurePiece(StructureSettings settings, ResourceKey<Biome> matchingBiome) {
